...
<table>
  ...
  <tr>
    <td colspan="2" valign="top">
      <h4>🌐 多厂商接入</h4>
      <p>支持 DeepSeek、通义千问、智谱 GLM、Kimi、SiliconFlow、OpenAI、Anthropic、Ollama 以及 New API / One API 网关。</p>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <b>📝 文本生成</b>
      <ul>
        <li>AI 提供者（DeepSeek / 通义千问 / 智谱 / Kimi / SiliconFlow / OpenAI / Anthropic / Ollama / 自定义网关）</li>
        <li>模型名、API Key、Base URL</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <b>🖼️ 图像生成</b>（封面工作台使用）
